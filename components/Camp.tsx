...
const Camp = () => {
   return (
      <section
         ...
         <div
            className="flex h-[340px] lg:h-[400px] xl:h-[640px] w-full items-start 
            justify-start gap-8 overflow-x-auto hide-scrollbar">
            <CampSite
...
const CampSite = ({
   ...
   return (
      <div
         className={`w-full h-full min-w-[1100px] ${backgroundImage} bg-cover bg-no-repeat
         lg:rounded-tr-5xl 2xl:rounded-5xl `}>
         <div className="flex items-start justify-between flex-col h-full p-6 lg:px-20 lg:py-10">
